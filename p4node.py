...
class P4Node(object):
    ...
    def by_type(self, typename):
        return P4Node([f for f in self.vec if f.node_type in [typename, f'Type_{typename}']])
    ...
    def _urtype(self):
        """Follows the attributes type, type_ref, Type_Typedef and baseType as long as possible."""
        node = self
    ...
    def xdir(self, details=False, show_colours=True, depth=0):
        ...
        def get_details(d):
            ...
            if attr.vec is None:
                ...
                return (".", f'{attr_count}', clr_count if attr_count != 0 else clr_off)
        ...
        def condfun(data):
            ...
            _, det = data
            conds = (det[0:2] == ("#", 0), det[0:2] == ("**", 0), det[0:2] == ("*", 0), det[0] == "#", det[0] == "**", det[0] == "*", True)
